...
- internal/highlight/highlight.go — read `HighlightLine`, `DetectLexer`, `FormatterForProfile`, `SelectTheme` signatures; note the package is `highlight` imported as `github.com/tbcrawford/drift/internal/highlight`
- internal/theme/theme.go — read `DetectDarkBackground` signature; package is `theme` imported as `github.com/tbcrawford/drift/internal/theme`
...
- [ ] `internal/render/unified.go` imports `"github.com/tbcrawford/drift/internal/edittype"` (NOT the root `drift` package, to avoid import cycles)
- [ ] `internal/render/unified.go` imports `"github.com/tbcrawford/drift/internal/highlight"`
- [ ] `go build ./...` exits 0
</acceptance_criteria>
</task>
