...
Plans:
- [ ] 03-01: Research Lip Gloss v2 `HasDarkBackground` timeout behavior; implement `internal/theme/` with safe OSC 11 detection
...
Plans:
- [ ] 05-01: Implement `cmd/drift/main.go` with Cobra root command and flag definitions
- [ ] 05-02: Implement file path, stdin pipe, and `--from`/`--to` raw string input handling
